package org.example.springbootjava17.repository;
...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Query("SELECT new org.example.springbootjava17.dto.UserSummary" +
            "(u.username, u.email) " +
            "FROM UserEntity u " +
    ...
    @Query("SELECT new org.example.springbootjava17.repository.UserRepository$UserDbRow" +
            "(u.id, u.username, u.email)" +
            "FROM UserEntity u WHERE u.username=:username")
    Optional<UserDbRow> loadUserData(String username);


    @Query("SELECT new org.example.springbootjava17.dto.UserAddress(a.line1, a.city, a.state, a.zip)" +
